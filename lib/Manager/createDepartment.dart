                                          ...
                                          child: ListTile(
                                            ...
                                            leading: CircleAvatar(
                                              backgroundImage: NetworkImage(
                                                  "$ip/manager/getDepartmentIcon/${departlistID[index]}"),
                                            ),
                                          ),
                                        ),
                                      );
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: ListTile(
                                            title:
                                                Text(operaortlist[index].name),
                                            subtitle:
                                                Text(operaortlist[index].email),
                                            leading: operaortprofilelist[
                                                        index] ==
                                                    null
                                                ? Image.asset(
                                                          ...
                                                          TextButton(
                                                            onPressed:
                                                              ...
                                                              Session _session =
                                                                  Session();
                                                              await _session.get(
                                                                  "$ip/manager/deleteOperator/${operaortlist[index].operatorId}");
                                                              setState(() {
                                                                getDetp();
                                                                getOperator();
                                                              });
