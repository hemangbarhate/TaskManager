...
class AssignedContainer extends StatefulWidget {
  ...
  @override
  _AssignedContainerState createState() => _AssignedContainerState();
}

class _AssignedContainerState extends State<AssignedContainer> {
          ...
          child: Padding(
            ...
            child: Column(
             ...
             widget.backgrondColor != blueColor ?   Row(
               ...
               padding: const EdgeInsets.all(8.0),
               child: Container(
                 child: Text("waiting for Approval", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: blackColor.withOpacity(0.9)
                 ),),
               ),
             ),
